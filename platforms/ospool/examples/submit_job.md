...
- Once you are logged in to aces cluster, create [monte_carlo.py](../../../examples/monte_carlo.py) to your home folder location which would uaually be "/home/<ospool-username>"
